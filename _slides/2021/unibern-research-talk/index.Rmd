...
1. One of my main scientific contribution is

2. Previous speakers, ...

3. While investigating... 

4. TWDTW steps -- library -- matches 

5. Matches to maps time series 

6. Crop type maps application
...
<br><br>
.left-column[
**Mapping agricultural management practices using earth observation time series.**
]
...
.bg-washed-blue.b--dark-green.ba.bw0.br3.shadow-5.mt0.font130.ph2.center[**The arbitrary choice of time intervals can cause data artifacts harming further land-use change analysis.**]
