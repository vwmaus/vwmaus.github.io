...
<div class="copyright-container">
  <img src="img/Marco Dormino_UN_Photo-CC-BY-NC-ND-2.0.jpg" />
...
### **I investigate how to integrate and extract information from a variate of data sources and develop spatiotemporal analysis tools to support real world applications.**
]
...
- **Mining and regional development in Brazil (WU Vienna)**

- **Unemployment in coal mining regions (World Bank)**

- **Impact of heavy sand extraction in ecosystems (University of Copenhagen)**

- **Land use change in the world's mining regions (University of Queensland and University of Melbourne, Australia): Upcoming: Workshop in the Royal Geographical Society Annual International Conference 2021**
...
.font300[**How do we measure land-use change using satellite earth observations?**]
...
.bg-washed-blue.b--dark-green.ba.bw0.br3.shadow-5.mt0.font130.ph2.center[**The higher accuracy comes at a cost of an arbitrary selection of intervals that violates time and can create spurious causal links between variables on land change analysis.**]
...
.bg-washed-blue.b--dark-green.ba.bw0.br3.shadow-5.mt0.font130.ph2.center[**How to produce event-based information preserving temporal hierarchy?**]
...
- Geocomputation with R (e.g. GIS operations in vector, raster and data cubes)
...
- *Prerequisite:* Math I and II, Geoprocessing I and II, Statistics
- *Related/Complementary to:* Quantitative methods, Network analysis
...
### Short-term research
  ...
  - Investigate whether different crop management can be detected in satellite image time series

--

### Long-term research 
  - Develop methods to extract and analyze events using satellite earth observation time series

--

### Potential initial collaborations topics with GIUB (but not limited to)

- Remote sensing: Vegetation an snow time series analysis

- Climatology: Detecting patterns in long-term climate time series

- Land systems and sustainable land management: mapping and monitoring land management systems using EO data
...
for(i in 1:18){
  ...
  p <- add_lines(p, name = paste("Segment", i), x = c(v.year, v.year), y = c(min(ts$EVI), max(ts$EVI)), visible="legendonly", line = list(color = "#ff7f0e", widthh=1, dash="dot"), legendgroup = 'group2')
}
p
```
