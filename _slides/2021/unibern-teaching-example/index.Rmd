...
.font130[This lecture is an excerpt of the lecture: **Earth observation time series and change detection**]
...
- Basic skills in R programming language from geodata (learned in Unit I of this course)
...
---
class: inverse, mline
# Classroom practical example

.footnote-right.font-light[Contains modified Copernicus Sentinel data 2018-2020]

.right-column[![:scale 100%](img/kayapo.gif)]

.left-column.font-light[Mining within the Indigenous Territory Kayapó in Brazil]
...
.pull-left[<img align="center" src="./index_files/figure-html/zoom-map-1.png" height="400"/>]
.pull-right[<img align="left" src="./index_files/figure-html/ts-plot-1.png" height="450"/>]
]
...
- .font150[In the second part of this lecture we will learn how automatically detect change in satellite image time series]

- .font150[Automatic finding temporal patterns]
...
<br>
Slides available from [https://victor-maus.com/assets/slides/2021/unibern-teaching-example/index.html](https://victor-maus.com/assets/slides/2021/unibern-teaching-example/index.html)
...
<!-- --- -->
<!-- # Satellite image time series as a data cube -->
