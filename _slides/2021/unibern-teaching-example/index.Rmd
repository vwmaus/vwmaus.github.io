...
```{r eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, results='hide', fig.show='hide'}
...
```{r ts3-mt-plot, eval=FALSE, echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, results='hide', fig.show='hide'}
library(plotly)
library(magrittr)
