...
```{r cube-subset, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, results='hide', fig.show='hide'}
...
.pull-left[<img align="center" src="./index_files/figure-html/cube-subset-1.png" height="400"/>]
.pull-right[
