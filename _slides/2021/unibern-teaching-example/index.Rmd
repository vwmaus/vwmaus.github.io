...
subtitle: "Unit 2: Detecting events and patterns<br><br>.font70[This lecture is an excerpt of the lecture: **Earth observation time series and change detection]**"
...
<div class="extension-tile-course maximum-red">Unit 2<br>Detecting events and patterns</div>
<div class="extension-tile-course bg1-grey">Unit 3<br>Predictive analysis using machine learning</div>
</div>

--

This lecture is an excerpt of the lecture: **Earth observation time series and change detection**
...
- Extract and visualize image time series
...
# Let's look into an application while learning how to construct our first data cube using R

???

---
class: inverse, mline, center
background-image: url(img/kayapo.gif)
...
# Plot cube subset -- not that we selecting a few date 
plot(zoom_cube[,,,seq(2,40,5)], breaks = "equal", col = rev(hcl.colors(20, "viridis")), key.pos = 4)
```
]
...
- .font150[In the second part of this lecture we will learn how automatically detect changes events in time series]
