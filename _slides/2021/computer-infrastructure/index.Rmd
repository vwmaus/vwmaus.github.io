...
.center.bg-washed-blue.b--dark-blue.ba.bw2.br3.shadow-5.mb0[**Hardware**]
  ...
  - **Access to HPC CPU and GPU clusters:** The cluster will be used for large scale applied research. UBELIX will provide sufficient processing resources.
...
.center.bg-washed-blue.b--dark-blue.ba.bw2.br3.shadow-5.mb1[**Questions**]
  ...
  - Are there satellite data archives available in the UBELIX cluster network? If not, would it be possible to have?
