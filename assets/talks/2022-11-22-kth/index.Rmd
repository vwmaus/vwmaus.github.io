...
---
class: clear
background-image: url(./../img/scp-hat-sweden-consumption-2018.png)
...
**Geospatial information necessary for sustainability assessments is not disclosed by the mining industry**
]
...
.font-dark.center.font250.font-light[
**Global mineral extraction is growing fast and we lack comprehensive geospatial information to assess its impacts**
]
...
.font-dark.left.font150[
**Global datasets lack local relevance**
]

<img src="./../img/esa-cci-carajas.png" height="500"/>
...
.font-dark.left.font150.center[
**EO data and processing infrastructure are available. However, it is still challenging to produce trustworthy global information that is at the same time locally relevant**
]
