...
date: ".right[.font80[Open Earth Monitor, Global Workshop 2023, Oct 6, 2023, Bolzano].footnote-right-title[Except where otherwise noted, content on these slides is licensed under <a href='https://creativecommons.org/licenses/by-sa/4.0'>CC BY-SA 4.0 license</a>]]"
notes: |
  <ul>
  <li>XXXXXXXXX</li>
  <br>
...
.center[<img src="https://www.mdpi.com/remotesensing/remotesensing-13-02428/article_deploy/html/images/remotesensing-13-02428-g003-550.jpg">]

.footnote-right[Figure: [Petitjean et al., 2012](https://doi.org/10.1109/TGRS.2011.2179050)]
...
- Higher demand for quality training samples
...
<!-- ### Why: we can use the time dimension to reduce the variability in the samples measurments -->
...
.pull-left[
```{r, eval=T, echo=F, dev='png', dev.args=list(bg='transparent')}
...
# Density plot of overall accuracy
...
### The classification uses a single sample per class
...
Interface to satllite image time series
