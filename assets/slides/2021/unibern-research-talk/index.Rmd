...
- My main contribution to that was the development of a novel method to extraction land-use and land-cover information from EO time series (EOTS)
...
.pull-right[
.bg-washed-red.b--dark-red.ba.bw0.br3.shadow-5.pb1.pt1.mt4.font100[
**Synthetic-aperture radar for measuring extraction volume**
]]

## neeeds modification -- maybe using nerow column left and large column right 

???

- This map shows the locations of more than 21,000 polyogns which my team produced to fill the mining data gap

- This data has been produce via visual interpretation of satellite images from various sources and covers more than XXXXX different materials 

- I am new finishing a second release of the data set which will include more than 50,000 polygons
...
- Because of the lack of spatial data on mining activities, this data product got broad visibility 

- It has been featured in the "Mine Magazine"

- And it also resulted in several follow up research and collaborations (examples in the slide) 

- As you can see there is a vast range of research topics are making use of the data and which I would never have imaged

- Therefore, highlighting the importance of open data and open science
...
- Therefore, I propose this folowing research question
